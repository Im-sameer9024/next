...
const List = ({id,image,name,place,rating,review,minPrice,maxPrice,exam}:allData) => {
  ...
  return (
    <div className='w-full h-auto'>
      <div className='  p-3 rounded-2xl border border-[#424242] flex justify-between'>
        ...
        {/* section section  */}
        <div className=' flex flex-col justify-between gap-3 w-5/12 '>
        ...
        <div className=' flex flex-col justify-between  w-[7rem]  gap-3'>
